...
* Import the polymorphism-pair-exercises project into Eclipse.
* You should create a package for each command line application you are working on inside of the `src/main/java/com/techelevator` package
    * One package will be named `PostageCalculator`
    * The other package will be named `TollBoothCalculator`
    * The code for each of the programs, to include classes and interfaces for each, will be in each of their respective packages.
